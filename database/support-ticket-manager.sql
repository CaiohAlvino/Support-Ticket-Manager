...
--
-- Banco de dados: `support-ticket-manager`
--
...
(1, 1, 'CPF', '', NULL, 'Vamonos Pest', '(44) 9 9169-2589', NULL, 'Todd Alquist', 'todd@gmail.com', '(44) 9 9169-2589', '556.246.944-82', '87203-460', 'Cianorte', 'Paraná', NULL, '', '123', 'Jardim Universidade I', 1, '2025-05-17 21:37:41', '2025-06-24 01:50:22'),
...
(6, 'Madrigal Electromotive GmbH', 1, '2025-06-24 01:51:36', '2025-06-24 01:51:36');
...
(3, 3, 5, 1, '2025-06-24 01:59:44', '2025-06-24 01:59:44'),
(4, 2, 5, 1, '2025-06-24 01:59:50', '2025-06-24 01:59:50'),
(5, 6, 5, 1, '2025-06-24 02:00:00', '2025-06-24 02:00:00'),
(6, 2, 4, 1, '2025-06-24 02:00:11', '2025-06-24 02:00:11'),
(7, 1, 4, 1, '2025-06-24 02:00:22', '2025-06-24 02:00:22'),
(8, 3, 3, 1, '2025-06-24 02:00:31', '2025-06-24 02:00:31'),
(9, 6, 3, 1, '2025-06-24 02:00:41', '2025-06-24 02:00:41'),
(10, 4, 3, 1, '2025-06-24 02:01:41', '2025-06-24 02:01:41'),
(11, 4, 2, 1, '2025-06-24 02:01:55', '2025-06-24 02:01:55'),
(12, 3, 1, 1, '2025-06-24 02:02:35', '2025-06-24 02:02:35'),
(13, 1, 5, 1, '2025-06-24 02:16:45', '2025-06-24 02:16:45'),
(14, 1, 2, 1, '2025-06-24 02:17:38', '2025-06-24 02:17:38');
...
(1, 1, 3, 1, '2025-06-03 12:00:08', '2025-06-24 02:03:57'),
(2, 2, 5, 1, '2025-06-03 12:00:08', '2025-06-24 02:05:03'),
(3, 3, 1, 1, '2025-06-03 12:00:25', '2025-06-03 12:00:25'),
(4, 1, 2, 1, '2025-06-03 12:00:25', '2025-06-03 12:00:25'),
(5, 1, 4, 1, '2025-06-03 12:00:38', '2025-06-24 02:13:56'),
(6, 3, 4, 1, '2025-06-11 00:29:17', '2025-06-11 00:29:17'),
(7, 4, 2, 1, '2025-06-24 02:07:26', '2025-06-24 02:07:26'),
(8, 5, 6, 1, '2025-06-24 02:11:50', '2025-06-24 02:11:50'),
(9, 6, 4, 1, '2025-06-24 02:12:00', '2025-06-24 02:12:00'),
(10, 6, 1, 1, '2025-06-24 02:12:07', '2025-06-24 02:12:07');
...
(3, 'SUPORTE Venezia\'s', 1, '2025-06-03 12:01:37', '2025-06-24 01:53:20'),
(4, 'SUPORTE Caltech', 1, '2025-06-08 03:16:03', '2025-06-24 01:53:31'),
(5, 'SUPORTE methtech', 1, '2025-06-08 03:16:09', '2025-06-24 01:53:43'),
(6, 'SUPORTE AMC', 1, '2025-06-11 03:59:44', '2025-06-24 01:53:50'),
(7, 'SUPORTE Dos Hombres', 1, '2025-06-24 01:54:10', '2025-06-24 01:54:10'),
(8, 'SUPORTE Madrigal Electromotive GmbH', 1, '2025-06-24 01:54:24', '2025-06-24 01:54:24');
...
CREATE TABLE `suporte` (
  ...
  `servico_id` int NOT NULL,
  `cliente_id` int NOT NULL,
  `usuario_id` int DEFAULT NULL COMMENT 'Só é atribuído manualmente ou se interagir com o SUPORTE',
...
(1, 6, 1, 2, 4, 'Meu Site de caiu (https://salahmed-ctrlz.github.io/BetterCallSaul/#/)', 'FECHADO', 1, '2025-06-01 14:22:22', '2025-06-24 02:18:37'),
(2, 4, 2, 3, 10, 'O sistema da minha lanchonete está com defeito no Login', 'RESPONDIDO', 1, '2025-06-03 12:10:31', '2025-06-24 02:08:19'),
...
(1, 1, 'Caio Alvino', 'caioh.alvino22@gmail.com', '$2y$10$kv32YhV1OWyVYIJQucLqa.Y7Em6LV0oY44a.hqBtIdDhuyij3l.0G', '532dae686311f9b5e4dc02179b2254d16585ffb31658061457f6bad56e9a028e', 1, '2025-05-17 21:34:48', '2025-06-24 01:46:36'),
...
(4, 3, 'Suporte Venezia\'s', 'venezia@suporte.com', '$2y$10$kv32YhV1OWyVYIJQucLqa.Y7Em6LV0oY44a.hqBtIdDhuyij3l.0G', '2a3cc09f7c8fcd5aff32399c2eccfe485e2495611d2a9bd8925f083aa8b41915', 1, '2025-06-08 03:16:50', '2025-06-24 01:58:01'),
(5, 4, 'Suporte Caltech', 'caltech@suporte.com', '$2y$10$kv32YhV1OWyVYIJQucLqa.Y7Em6LV0oY44a.hqBtIdDhuyij3l.0G', '494aad6bf22fab78472a19afd5a7b34657c6ff12704976c2f08a12444a6e7ad8', 1, '2025-06-08 03:17:14', '2025-06-24 01:58:10'),
(6, 5, 'Suporte methtech', 'methtech@suporte.com', '$2y$10$kv32YhV1OWyVYIJQucLqa.Y7Em6LV0oY44a.hqBtIdDhuyij3l.0G', NULL, 1, '2025-06-08 03:18:37', '2025-06-24 01:58:17'),
...
(10, 6, 'Suporte AMC', 'amc@suporte.com', '123', NULL, 1, '2025-06-11 03:54:54', '2025-06-24 01:58:29');
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `fk_cliente_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`);

--
-- Restrições para tabelas `empresa_cliente`
--
ALTER TABLE `empresa_cliente`
  ADD CONSTRAINT `fk_empresa_cliente_cliente1` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`),
  ADD CONSTRAINT `fk_empresa_cliente_empresa1` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`id`);

--
-- Restrições para tabelas `empresa_servico`
--
ALTER TABLE `empresa_servico`
  ADD CONSTRAINT `fk_empresa_servico_empresa1` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`id`),
  ADD CONSTRAINT `fk_empresa_servico_servico1` FOREIGN KEY (`servico_id`) REFERENCES `servico` (`id`);

--
-- Restrições para tabelas `empresa_usuario`
--
ALTER TABLE `empresa_usuario`
  ADD CONSTRAINT `fk_empresa_usuario_empresa1` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`id`),
  ADD CONSTRAINT `fk_empresa_usuario_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`);

--
-- Restrições para tabelas `suporte`
--
ALTER TABLE `suporte`
  ADD CONSTRAINT `fk_suporte_cliente1` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`),
  ADD CONSTRAINT `fk_suporte_empresa1` FOREIGN KEY (`empresa_id`) REFERENCES `empresa` (`id`),
  ADD CONSTRAINT `fk_suporte_servico1` FOREIGN KEY (`servico_id`) REFERENCES `servico` (`id`),
  ADD CONSTRAINT `fk_suporte_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`);

--
-- Restrições para tabelas `suporte_mensagem`
--
ALTER TABLE `suporte_mensagem`
  ADD CONSTRAINT `fk_suporte_mensagem_suporte1` FOREIGN KEY (`suporte_id`) REFERENCES `suporte` (`id`);
