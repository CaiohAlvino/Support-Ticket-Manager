...
// Limite para consulta (relatório = todos)
$limiteConsulta = ($relatorio == 1) ? null : 15;

$indexRegistros = $classEmpresa->index([
    "nome" => $nome,
    "pagina" => $pagina,
...
<?php
// Limite para navegação visual (não interfere na consulta)
$limiteNavegacao = 2;
...
<script>
    ...
    // Imprime automaticamente ao carregar se já estiver no modo relatório
