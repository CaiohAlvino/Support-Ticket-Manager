...
<div class="sessao">
    <div class="row">
        ...
        <div class="col-xl-10 col-lg-10 col-md-8 col-sm-12 col-12">
            <h1 class="titulo">Cadastrar Grupo</h1>
        </div>
    </div>
</div>

<div class="sessao">
    <form id="grupo-cadastrar" data-action="grupo/cadastrar.php">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                <label for="nome" class="form-label">Nome da Grupo <span class="campo-obrigatorio text-danger">*</span></label>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3 text-end">
                <button type="submit" class="btn btn-confirmar botao-noty-ativo">
                    <i class="bi-check-lg"></i> Cadastrar grupo
                </button>
            </div>
        </div>
    </form>
