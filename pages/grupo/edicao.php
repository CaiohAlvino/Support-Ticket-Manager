...
$grupo = $classGrupo->pegarPorId($id);
?>
...
<div class="sessao">
    <form id="grupo-editar" data-action="grupo/editar.php">
        <input type="hidden" name="id" value="<?php echo htmlspecialchars($grupo->id); ?>">
        <div class="row">
            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-12 mb-3">
                ...
                <select name="ativo" id="ativo" class="form-select">
                    <option value="1" <?php echo $grupo->situacao == 1 ? 'selected' : ''; ?>>Ativo</option>
                    <option value="0" <?php echo $grupo->situacao == 0 ? 'selected' : ''; ?>>Inativo</option>
                </select>
            </div>

            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-8 col-12 mb-3">
                <label for="nome" class="form-label">Nome do Grupo <span class="campo-obrigatorio text-danger">*</span></label>
                <input type="text" class="form-control input-validar-nome campo-obrigatorio" id="nome" name="nome" value="<?php echo htmlspecialchars($grupo->nome); ?>" placeholder="Digite o nome do grupo" required>
            </div>
