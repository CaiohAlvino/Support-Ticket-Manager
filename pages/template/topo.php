    ...
    <header class="header">
        <div class="header-content">
            <div class="d-flex align-items-center gap-3">
                <button class="menu-toggle d-lg-none btn btn-link p-0 me-2" id="menuToggle" aria-label="Toggle Menu">
                    <i class="bi bi-list fs-2"></i>
                </button>
                <a href="../home/index.php" class="logo d-flex align-items-center text-decoration-none">
                    <i class="bi bi-ticket-perforated fs-3 me-2"></i>
                    <span class="brand-text fw-bold fs-4">Support</span>
                </a>
            </div>
            <div class="d-flex align-items-center gap-3">
                <div class="dropdown">
                    <button class="dropdown-toggle btn btn-light d-flex align-items-center gap-2" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <nav class="sidebar" id="sidebar">
        <div class="sidebar-nav">
            <div class="sidebar-section mb-2">
                <small class="text-muted text-uppercase ms-2">Tickets</small>
                <a href="../home/index.php" class="sidebar-link menu-item"><i class="bi bi-grid-1x2-fill"></i>Dashboard</a>
                <a href="../suporte/index.php" class="sidebar-link menu-item"><i class="bi bi-list-ul"></i>Todos os Tickets</a>
                <a href="../suporte/meus-tickets.php" class="sidebar-link menu-item"><i class="bi bi-ticket-fill"></i>Meus Tickets</a>
            </div>
            <div class="sidebar-section mb-2">
                <small class="text-muted text-uppercase ms-2">Cadastros</small>
                <a href="../empresa/index.php" class="sidebar-link menu-item"><i class="bi bi-building"></i>Empresas</a>
                <a href="../servico/index.php" class="sidebar-link menu-item"><i class="bi bi-award-fill"></i>Serviço</a>
                <a href="../cliente/index.php" class="sidebar-link menu-item"><i class="bi bi-people"></i>Clientes</a>
            </div>
            <div class="sidebar-section">
                <small class="text-muted text-uppercase ms-2">Configurações</small>
                <a href="../usuario/index.php" class="sidebar-link menu-item"><i class="bi bi-person"></i>Usuários</a>
                <a href="../grupo/index.php" class="sidebar-link menu-item"><i class="bi bi-shield-lock"></i>Grupo</a>
            </div>
        </div>
    </nav>
